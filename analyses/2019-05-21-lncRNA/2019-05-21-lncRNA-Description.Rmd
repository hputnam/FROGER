...
```{bash}
grep "lnc_RNA" C_virginica-3.0_Gnomon_lncRNA_yrv.gff > C_virginica-3.0_Gnomon_lncRNA_noexons_yrv.gff3
```


```{bash}
/Users/Shared/bioinformatics/bedtools2/bin/intersectBed -u -a C_virginica-3.0_CG-motif.bed -b {lncRNAList} | wc -l #CG motif overlaps with lncRNA
```
